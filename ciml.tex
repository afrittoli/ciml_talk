...
\definecolor{osseu}{RGB}{26,107,56}
\setbeamercolor{titlelike}{fg=osseu}
\setbeamercolor{structure}{fg=osseu}
\hypersetup{colorlinks,urlcolor=osseu}
...
\lstset{ %
  ...
  commentstyle=\color{osseu},        % comment style
  ...
  stringstyle=\color{osseu},         % string literal style
}
...
\node[anchor=east]
    at ([yshift=-45pt,xshift=-30pt]current page.north east) (title)
  {\parbox[t]{.6\paperwidth}{\raggedleft%
    \usebeamerfont{author}\textcolor{white}{\Huge \inserttitle}}};
\node[anchor=east]
  at ([yshift=-30pt,xshift=-20pt]current page.east) (author)
  {\parbox[t]{\textwidth}{\raggedleft%
 \usebeamerfont{author}\textcolor{white}{\insertauthor}}};
\node[anchor=south west]
at([yshift=+10pt,xshift=-25pt]current page.south west) (link)
  {\parbox[t]{\textwidth}{\raggedleft
\usebeamerfont{colorlinks}\textcolor{white}{\href{https://github.com/afrittoli/ciml\_talk}{https://github.com/afrittoli/ciml\_talk}}}};
\end{tikzpicture}
}
...
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{white_bg.png}
}
...
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{cfc1.png}}

\begin{frame}
\end{frame}

\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{cfc2.png}}
