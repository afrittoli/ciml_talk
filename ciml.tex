...
\begin{frame}
  ...
  \begin{itemize}
      ...
      \item{Valuable insights can be gathered from system data using ML}
...
\begin{frame}
  ...
  \end{itemize}
  \begin{itemize}
    \item Kyra Wulffert \raisebox{-.2\height}{\includegraphics[width=12pt]{img/twitter.png}} \href{https://twitter.com/kwulffert/}{@kwulffert} \raisebox{-.2\height}{\includegraphics[width=14pt]{img/linkedin.png}} \href{https://www.linkedin.com/in/kyrawulffert/}{kyrawulffert}
